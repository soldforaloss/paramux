...
| `scripts/smoke-de.ps1` | the GUI boots and answers IPC under `ui-language = de` (XDG_CONFIG_HOME override, real config untouched) |
...
`v0.1.18`. See [PACKAGING.md](PACKAGING.md) before changing release

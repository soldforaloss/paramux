...
/// running paramux from the source, this is the `zig-out/share/ghostty/themes`
/// directory.
///
...
pub fn run(gpa_alloc: std.mem.Allocator) !u8 {
    ...
    if (resources_dir == null) {
        try stderr.print("Could not find the paramux resources directory. Please ensure " ++
            "that paramux is installed correctly.\n", .{});
        try stderr.flush();
    }
...
const Preview = struct {
    ...
    pub fn run(self: *Preview) !void {
        ...
        try self.vx.setTitle(writer, "paramux Theme Preview");
        ...
        switch (self.mode) {
            ...
            .save => {
                ...
                const save_instructions = [_][]const u8{
                    ...
                    "",
                    "To apply this theme, add the following line to your paramux configuration:",
                    "",
                    ...
                    "Then add the following line to your paramux configuration and reload:",
                    "",
            ...
            }
            {
                ...
                _ = child.print(
                    &.{
                        ...
                        .{ .text = "via ", .style = standard },
                        .{ .text = "  impure (paramux-env)", .style = color4 },
                    },
                    .{
                        .row_offset = 22,
                        .col_offset = 2,

...
fn showWindowsCliFailureDialog(message: []const u8) void {
    ...
    const caption = std.unicode.utf8ToUtf16LeStringLiteral("paramux CLI action failed");
    const fallback = std.unicode.utf8ToUtf16LeStringLiteral("paramux CLI action failed.");

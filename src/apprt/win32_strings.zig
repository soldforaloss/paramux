...
pub const Strings = struct {
    ...
    // Settings-window buttons, checkboxes, and search cues.
    settings_open_editor: [:0]const u16 = w("Open in default editor"),
    settings_save: [:0]const u16 = w("Save"),
    settings_open_keybinds: [:0]const u16 = w("Open config for keybinds"),
    settings_search_themes_cue: [:0]const u16 = w("Search themes..."),
    settings_explorer_checkbox: [:0]const u16 = w("Add \"Open in Paramux\" to the Explorer right-click menu"),
    settings_trim_copy: [:0]const u16 = w("Trim trailing spaces on copy"),
    settings_allow_notifications: [:0]const u16 = w("Allow terminal desktop notifications"),
    settings_notify_clipboard: [:0]const u16 = w("Notify when clipboard copy completes"),
    settings_notify_reload: [:0]const u16 = w("Notify after config reload"),
    settings_search_cue: [:0]const u16 = w("Search settings..."),
...
pub const german: Strings = .{
    ...
    .settings_open_editor = w("Im Standard-Editor \u{00F6}ffnen"),
    .settings_save = w("Speichern"),
    .settings_open_keybinds = w("Konfiguration f\u{00FC}r Tastenk\u{00FC}rzel \u{00F6}ffnen"),
    .settings_search_themes_cue = w("Designs durchsuchen..."),
    .settings_explorer_checkbox = w("\u{201E}Open in Paramux\u{201C} zum Explorer-Rechtsklickmen\u{00FC} hinzuf\u{00FC}gen"),
    .settings_trim_copy = w("Leerzeichen am Zeilenende beim Kopieren entfernen"),
    .settings_allow_notifications = w("Desktop-Benachrichtigungen des Terminals erlauben"),
    .settings_notify_clipboard = w("Nach abgeschlossenem Kopieren benachrichtigen"),
    .settings_notify_reload = w("Nach Konfigurations-Reload benachrichtigen"),

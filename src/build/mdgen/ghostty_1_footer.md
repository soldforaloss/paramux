...
_\$XDG_CONFIG_HOME/paramux/config.ghostty_

: Location of the default configuration file.

_\$HOME/Library/Application Support/io.github.soldforaloss.paramux/config.ghostty_

: **On macOS**, location of the default configuration file. This location takes
precedence over the XDG environment locations.

_\$LOCALAPPDATA/paramux/config.ghostty_
...
**$HOME/Library/Application Support/io.github.soldforaloss.paramux**
...
See GitHub issues: <https://github.com/soldforaloss/paramux/issues>

# AUTHOR

Aman Thanvi and contributors <https://github.com/soldforaloss/paramux/graphs/contributors>

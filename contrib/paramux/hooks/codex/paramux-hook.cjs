...
const EVENTS = Object.freeze({
  ...
  PermissionRequest: Object.freeze({
    state: "waiting",
    message: "Codex CLI needs your approval",
    usePayloadMessage: true,
  }),
  Stop: Object.freeze({
    state: "done",
    message: "Codex CLI finished responding",
  }),
  ...
  SessionEnd: Object.freeze({
    state: "none",
    message: "Codex CLI session ended",
  }),
});
...
// and oversized payloads. Keep in sync with the Gemini adapter.
...
function fail(message, exitCode = 1) {
  process.stderr.write(`paramux Codex hook: ${message}\n`);

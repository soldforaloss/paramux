const PRODUCT_FACTS = [
  ...
  },
  {
    ...
    a: 'A public, unsigned Windows x64 portable prerelease: v0.1.0-paramux.7. It ships the agent-hook adapters, the +send/+send-key automation verbs, and the fully Paramux-branded package.',
  },
  {

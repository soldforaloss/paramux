...
| Current distribution | The public `v0.1.6` release contains one unsigned x64 portable ZIP, `SHA256SUMS-windows-x64.txt`, and the `install-paramux.cmd` PATH helper. Signed installer, WinGet, Scoop, ARM64, and public stable channels are planned. |

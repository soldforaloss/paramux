...
| Current distribution | The public `v0.1.9` release contains unsigned x64 and ARM64 portable ZIPs with per-arch `SHA256SUMS` files and the `install-paramux.cmd` PATH helper. Signed installer, WinGet, Scoop, and public stable channels are planned. |

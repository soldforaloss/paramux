...
Last reviewed: 2026-07-10, against the public `v0.1.0-paramux.9`
prerelease.
...
- `v0.1.0-paramux.9` is public, portable, prerelease-only, and unsigned.
...
- The release contains `paramux-0.1.0-paramux.9-windows-x64-portable.zip` and

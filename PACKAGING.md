...
```text
dist\artifacts\paramux-0.1.0-paramux.6-windows-x64\
```
...
Get-FileHash `
  .\dist\artifacts\paramux-0.1.0-paramux.6-windows-x64\paramux-0.1.0-paramux.6-windows-x64-portable.zip `
  -Algorithm SHA256
```
...
For `v0.1.0-paramux.6`, `NotSigned` is the expected signature status. A future
